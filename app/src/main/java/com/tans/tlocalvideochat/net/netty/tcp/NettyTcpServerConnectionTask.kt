package com.tans.tlocalvideochat.net.netty.tcp

import com.tans.tlocalvideochat.net.netty.handlers.BytesToPackageDataDecoder
import com.tans.tlocalvideochat.net.netty.handlers.CheckerHandler
import com.tans.tlocalvideochat.net.netty.handlers.PackageDataToBytesEncoder
...
class NettyTcpServerConnectionTask(
    ...
    inner class ChildConnectionTask(private val socketChannel: NioSocketChannel) :
