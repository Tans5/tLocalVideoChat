...
import com.tans.tlocalvideochat.databinding.OptionalDialogLayoutBinding
...
class OptionalDialog : BaseCoroutineStateCancelableResultDialogFragment<Unit, Boolean> {
    ...
    override fun bindContentView(view: View) {
        ...
        viewBinding.positiveButton.visibility = if (positiveButtonText != null) View.VISIBLE else View.GONE
        viewBinding.negativeButton.visibility = if (negativeButtonText != null) View.VISIBLE else View.GONE
